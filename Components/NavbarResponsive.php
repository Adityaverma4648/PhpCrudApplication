<div class="resNavbar col-sm-2 end-0 position-fixed bg-dark d-flex flex-column border-top border-info d-none" style="z-index:999999;height:93vh;width:50vw;margin-top:5.3rem" id="resNavbar">
    ...
    <div class="col-sm-12 d-flex flex-column justify-content-center align-items-center">
        ...
        <div class="container-fluid py-3 border-bottom border-secondary bg-opacity-50 resNavbarCustLi">
            <a href="../../PhpCrudApplication/About.php" class="text-decoration-none">
                About
            </a>
        </div>
        <div class="container-fluid py-3 border-bottom border-secondary bg-opacity-50 resNavbarCustLi">
